package com.humber.Lab5JPAFoodApp;
...
public class Lab5JPAFoodAppApplication implements CommandLineRunner {

	@Autowired
	// constructor injection // making object of dish service class
	private final DishService dishService;

	public Lab5JPAFoodAppApplication(DishService dishService) {
