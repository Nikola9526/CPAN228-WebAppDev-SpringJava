package com.humber.Week8_JPA_SpringSecurity_Regis;

import com.humber.Week8_JPA_SpringSecurity_Regis.models.Dish;
import com.humber.Week8_JPA_SpringSecurity_Regis.services.DishService;
...
public class Week8_JPA_SpringSecurity_RegisApplication implements CommandLineRunner {

	@Autowired
	// constructor injection // making object of dish service class
	private final DishService dishService;

	public Week8_JPA_SpringSecurity_RegisApplication(DishService dishService) {
		this.dishService = dishService;
	}

	public static void main(String[] args) {
		SpringApplication.run(Week8_JPA_SpringSecurity_RegisApplication.class, args);
	}
