package com.humber.Lab7_Week8_JPA_SpringSecurity;

import com.humber.Lab7_Week8_JPA_SpringSecurity.models.Dish;
import com.humber.Lab7_Week8_JPA_SpringSecurity.services.DishService;
...
public class Lab7_Week8_JPA_SpringSecurityApplication implements CommandLineRunner {

	@Autowired
	// constructor injection // making object of dish service class
	private final DishService dishService;

	public Lab7_Week8_JPA_SpringSecurityApplication(DishService dishService) {
		this.dishService = dishService;
	}

	public static void main(String[] args) {
		SpringApplication.run(Lab7_Week8_JPA_SpringSecurityApplication.class, args);
	}
