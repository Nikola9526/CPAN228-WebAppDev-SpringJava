package com.humber.Lab7_Week8_JPA_SpringSecurity.controllers;
...
//only Menu and Home here
    ...
    public String home(Model model , @RequestParam(required = false) String message){
        // checks to authentication statues  in Security Context and returns boolean depended on if authenticated is null or not
