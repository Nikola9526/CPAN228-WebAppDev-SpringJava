package com.humber.Week6_Lab5JPAFoodApp;

import com.humber.Week6_Lab5JPAFoodApp.models.Dish;
import com.humber.Week6_Lab5JPAFoodApp.services.DishService;
...
public class Week6_Lab5JPAFoodAppApplication implements CommandLineRunner {

	@Autowired
	// constructor injection // making object of dish service class
	private final DishService dishService;

	public Week6_Lab5JPAFoodAppApplication(DishService dishService) {
		this.dishService = dishService;
	}

	public static void main(String[] args) {
		SpringApplication.run(Week6_Lab5JPAFoodAppApplication.class, args);
	}
