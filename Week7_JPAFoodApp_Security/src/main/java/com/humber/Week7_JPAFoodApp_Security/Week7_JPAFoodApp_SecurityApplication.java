package com.humber.Week7_JPAFoodApp_Security;
...
public class Week7_JPAFoodApp_SecurityApplication implements CommandLineRunner {

	@Autowired
	// constructor injection // making object of dish service class
	private final DishService dishService;

	public Week7_JPAFoodApp_SecurityApplication(DishService dishService) {
		this.dishService = dishService;
	}

	public static void main(String[] args) {
		SpringApplication.run(Week7_JPAFoodApp_SecurityApplication.class, args);
	}
